...
AppId={{EA02F721-E418-4743-A996-624147EBD6E2}
AppName={#MyAppName}
...
OutputBaseFilename=blink-1.10.1-setup
Compression=lzma
...
[Files]
Source: "C:\BlinkDeploy\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
